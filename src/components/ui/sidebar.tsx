  ...
  if (isMobile) {
    return (
      <Sheet onOpenChange={setOpenMobile} open={openMobile}>
        <SheetContent
          className="w-[260px] bg-sidebar p-0 text-sidebar-foreground border-r border-sidebar-border"
          data-mobile="true"
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "-translate-x-1/2 group-data-[side=left]:-right-4 absolute inset-y-0 z-20 hidden w-4 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=right]:left-0 lg:flex",
  ...
  return (
    <main
      className={cn(
        ...
        "lg:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2 lg:peer-data-[variant=inset]:m-2 lg:peer-data-[variant=inset]:ms-0 lg:peer-data-[variant=inset]:rounded-xl lg:peer-data-[variant=inset]:shadow-sm/5",
        className,
      )}
...
function SidebarGroupAction({
  ...
  const defaultProps = {
    className: cn(
      ...
      "after:-inset-2 after:absolute lg:after:hidden",
